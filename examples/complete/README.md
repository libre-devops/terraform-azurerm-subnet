...
| Name | Description |
|------|-------------|
| <a name="output_calculated_subnets"></a> [calculated\_subnets](#output\_calculated\_subnets) | The calculator's per-subnet facts. |
...
| <a name="output_vnet_id"></a> [vnet\_id](#output\_vnet\_id) | The id of the virtual network the subnets were added to. |
<!-- END_TF_DOCS -->
